...
(declare-fun temp2_217_242 () String)
(declare-fun s242 () String)
(declare-fun temp1_217_242 () String)
...
(assert (= (str.++ temp1_217_242 temp2_217_242) s217) )
(assert (= (str.++ temp1_217_227 temp2_217_227) s217) )
(assert (= (str.len temp2_217_242) (str.len s242) ) )
