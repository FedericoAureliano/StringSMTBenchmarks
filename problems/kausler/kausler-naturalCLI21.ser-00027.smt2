...
(declare-fun temp2_135_160 () String)
...
(declare-fun temp1_135_160 () String)
...
(assert (not (= s160 temp2_135_160) ) )
(assert (= (str.++ s155 temp_135_155) s135) )
(assert (= (str.len temp2_135_160) (str.len s160) ) )
(assert (= (str.++ temp1_135_160 temp2_135_160) s135) )
