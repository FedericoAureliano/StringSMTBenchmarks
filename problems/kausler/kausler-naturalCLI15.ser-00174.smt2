...
(declare-fun temp2_972_998 () String)
...
(declare-fun temp1_972_998 () String)
...
(assert (= (str.++ temp1_972_998 temp2_972_998) s972) )
(assert (= (str.len temp2_972_998) (str.len s998) ) )
