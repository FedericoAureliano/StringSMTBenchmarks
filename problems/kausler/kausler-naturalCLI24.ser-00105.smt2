...
(declare-fun temp2_331_358 () String)
(declare-fun temp1_331_358 () String)
...
(assert (= (str.++ temp1_331_358 temp2_331_358) s331) )
...
(assert (= (str.len temp2_331_358) (str.len s358) ) )
