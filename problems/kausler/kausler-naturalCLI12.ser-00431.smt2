...
(assert (not (= s3512 s3462 )))
(assert (not (= s1478 temp1_1467_1478) ) )
(assert (not (= s3497 s3462 )))
(assert (= s3502 "email" ))
...
(assert (not (= s3522 s3462 )))
(assert (= s3497 "hexadecimal" ))
...
(assert (= s1520 "..." ))
(assert (not (= s3507 s3462 )))
(assert (not (= s1483 temp2_1467_1483) ) )
(assert (not (= s3487 s3462 )))
(assert (not (= s3492 s3462 )))
(assert (not (= s3517 s3462 )))
(assert (= s3487 "integer" ))
(assert (= s3482 "long" ))
(assert (not (= s3502 s3462 )))
(assert (= s3169 "..." ))
