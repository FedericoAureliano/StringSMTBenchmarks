...
(declare-fun temp2_431_456 () String)
(declare-fun s456 () String)
(declare-fun temp1_431_456 () String)

(assert (= (str.++ temp1_431_456 temp2_431_456) s431) )
(assert (not (= s441 temp1_431_441) ) )
(assert (= (str.len temp1_431_441) (str.len s441) ) )
(assert (= (str.len temp2_431_456) (str.len s456) ) )
