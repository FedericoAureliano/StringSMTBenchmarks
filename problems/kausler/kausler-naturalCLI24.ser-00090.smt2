...
(declare-fun temp_279_306 () String)
(declare-fun temp2_279_301 () String)
(declare-fun temp1_279_301 () String)
(declare-fun s306 () String)
(declare-fun temp1_279_306 () String)
(declare-fun temp2_279_306 () String)

(assert (= (str.++ temp1_279_291 temp2_279_291) s279) )
(assert (= (str.len temp2_279_306) (str.len s306) ) )
...
(assert (= (str.++ temp1_279_306 temp2_279_306) s279) )
(assert (not (= s306 temp2_279_306) ) )
(assert (not (= s291 temp1_279_291) ) )
(assert (= (str.++ temp_279_306 s306) s279) )
