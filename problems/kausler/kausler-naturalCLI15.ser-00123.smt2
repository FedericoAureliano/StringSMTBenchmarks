...
(declare-fun temp2_669_695 () String)
...
(declare-fun temp1_669_695 () String)
...
(assert (= (str.len temp2_669_695) (str.len s695) ) )
(assert (= (str.len temp1_669_690) (str.len s690) ) )
(assert (= (str.++ temp1_669_695 temp2_669_695) s669) )
(assert (not (= s695 temp2_669_695) ) )
