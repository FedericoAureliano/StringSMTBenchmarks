...
(declare-fun temp2_375_402 () String)
(declare-fun s392 () String)
(declare-fun temp1_375_402 () String)
(declare-fun temp_375_402 () String)
...
(assert (= (str.++ temp1_375_402 temp2_375_402) s375) )
(assert (not (= s392 temp2_375_392) ) )
(assert (not (= s402 temp2_375_402) ) )
(assert (= (str.++ temp1_375_387 temp2_375_387) s375) )
(assert (= (str.++ temp_375_402 s402) s375) )
(assert (= (str.len temp1_375_387) (str.len s387) ) )
(assert (= (str.len temp2_375_402) (str.len s402) ) )
