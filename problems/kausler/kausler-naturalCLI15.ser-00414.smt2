...
(declare-fun temp2_2560_2581 () String)
...
(assert (not (= s2581 temp1_2560_2581) ) )
(assert (= (str.++ s2581 temp_2560_2581) s2560) )
(assert (not (= s2576 temp2_2560_2576) ) )
(assert (= (str.++ temp1_2560_2581 temp2_2560_2581) s2560) )
