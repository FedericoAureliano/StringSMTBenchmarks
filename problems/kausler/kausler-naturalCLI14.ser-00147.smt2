...
(declare-fun temp_1210_1236 () String)
(declare-fun temp1_1210_1236 () String)
(declare-fun s1210 () String)
(declare-fun temp2_1210_1231 () String)
(declare-fun temp2_1210_1236 () String)
(declare-fun s1226 () String)
(declare-fun s1236 () String)
(declare-fun temp1_1210_1221 () String)
(declare-fun temp2_1210_1221 () String)
(declare-fun temp1_1210_1231 () String)
...
(assert (= (str.len temp2_1210_1236) (str.len s1236) ) )
(assert (not (= s1236 temp2_1210_1236) ) )
(assert (= (str.++ temp1_1210_1231 temp2_1210_1231) s1210) )
(assert (= (str.++ temp1_1210_1236 temp2_1210_1236) s1210) )
(assert (= (str.++ temp1_1210_1226 temp2_1210_1226) s1210) )
(assert (= (str.len temp2_1210_1226) (str.len s1226) ) )
(assert (= (str.len temp1_1210_1231) (str.len s1231) ) )
(assert (= (str.++ temp1_1210_1221 temp2_1210_1221) s1210) )
(assert (not (= s1231 temp1_1210_1231) ) )
(assert (= (str.++ temp_1210_1236 s1236) s1210) )
