...
(declare-fun temp1_1482_1508 () String)
(declare-fun temp2_1482_1493 () String)
(declare-fun temp_1482_1508 () String)
(declare-fun temp2_1482_1508 () String)
...
(assert (= (str.len temp2_1482_1508) (str.len s1508) ) )
(assert (not (= s1498 temp2_1482_1498) ) )
(assert (not (= s1508 temp2_1482_1508) ) )
...
(assert (= (str.++ temp1_1482_1508 temp2_1482_1508) s1482) )
